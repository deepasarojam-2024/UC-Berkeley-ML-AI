...
# Load the dataset
products_df = pd.read_csv("https://raw.githubusercontent.com/deepasarojam-2024/UC-Berkeley-ML-AI/main/Capstone-Project/retail_data.csv")   
country_counts_df = pd.read_csv("https://raw.github.com/deepasarojam-2024/UC-Berkeley-ML-AI/blob/main/Capstone-Project/country_counts.csv")
